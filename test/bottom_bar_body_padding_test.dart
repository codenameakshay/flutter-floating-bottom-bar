...
void main() {
  testWidgets(
    ...
    (tester) async {
                ...
                child: BottomBar(
                  ...
                  body: Align(
                    ...
                    child: BottomBarBodyPadding(
                      ...
                      child: SizedBox(key: bodyChildKey, width: 20, height: 20),
                    ),
                  ),
      ...
      expect(
        initialPadding.resolve(TextDirection.rtl),
        const EdgeInsets.fromLTRB(13, 7, 11, 103),
      );
      expect(
        tester.getTopLeft(find.byKey(bodyChildKey)).dy,
      ...
      expect(
        hiddenPadding.resolve(TextDirection.rtl),
        const EdgeInsets.fromLTRB(13, 7, 11, 103),
      );
      expect(
        tester.getTopLeft(find.byKey(bodyChildKey)).dy,
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final initialPadding = _bodyPadding(tester, bodyPaddingKey);
      expect(
        initialPadding.resolve(TextDirection.ltr),
      ...
      final hiddenPadding = _bodyPadding(tester, bodyPaddingKey);
      expect(
        hiddenPadding.resolve(TextDirection.ltr),
        const EdgeInsets.only(bottom: footprint),
      );
      expect(observedHeights.last, closeTo(footprint, 0.01));
      expect(
