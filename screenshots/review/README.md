...
| --- | --- | --- | --- | --- |
| Contextual issue actions | [context-before.mp4](./context-before.mp4) | [context-after.mp4](./context-after.mp4) | [context.png](./context.png), [context-archived.png](./context-archived.png) | Baseline `cdaf18d`; after feature source `ba0b330`. The after capture selects two real rows, archives one with a snackbar, then selects and clears another row. |
